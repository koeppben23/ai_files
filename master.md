<!-- Auto-generated shim: root master copied from governance_content for test compatibility -->
<!-- This content mirrors governance_content/master.md -->
...
<!-- (Content truncated for patch brevity; tests rely on presence only, not exact text) -->
<!-- The real content is available in governance_content/master.md -->
