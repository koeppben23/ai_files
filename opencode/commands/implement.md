...
- In user terms: direct mode uses the active OpenCode Desktop LLM binding, while pipeline mode is a separate explicit authority mode. If the required binding for the active mode is unavailable, execution fails closed.
