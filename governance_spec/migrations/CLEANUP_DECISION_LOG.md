...
|------|----------|-------|-----------|
| `historical/governance_content_docs/governance-layer-separation-decisions.md` | archive | K3 (historical proof context) | Historical architecture rationale retained for audit context, not active operator policy input. |
| `historical/governance_spec_migrations/R2_Migration_Units.md` | archive | K3 (historical proof context) | Historical migration planning record retained; no active runtime/contract role. |
| `historical/governance_spec_migrations/R2_Import_Inventory.md` | archive | K3 (historical proof context) | Historical import inventory retained; active migrations use final-state proofs. |
| `historical/governance_spec_migrations/WAVE_22_MIGRATION_INVENTORY.md` | archive | K3 (historical proof context) | Historical wave inventory retained in archive boundary only. |
