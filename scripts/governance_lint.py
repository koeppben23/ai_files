...
def main() -> int:
    ...
    # MD rails tripwire - keeping for other MD files but not enforcing on core 3
    # check_md_rails_only_tripwire(issues)
    # Output contract checks removed - these details moved to kernel/render layer
    ...
    # Output/detail checks commented out - MD files refactored to minimal guidance
