...
Usage:
    from governance_runtime.installer import collect_commands, collect_content
...
from governance_runtime.engine.command_surface import is_canonical_command
...
def collect_runtime(
    ...
    This includes:
    - Python code in governance_runtime/**
    - Entry points
