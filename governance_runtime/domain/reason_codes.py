...
BLOCKED_REVIEW_REMOTE_UNAVAILABLE: Final[str] = "BLOCKED-REVIEW-REMOTE-UNAVAILABLE"
BLOCKED_REVIEW_FETCH_FAILED: Final[str] = "BLOCKED-REVIEW-FETCH-FAILED"
BLOCKED_REVIEW_BASE_UNRESOLVED: Final[str] = "BLOCKED-REVIEW-BASE-UNRESOLVED"
BLOCKED_REVIEW_HEAD_UNRESOLVED: Final[str] = "BLOCKED-REVIEW-HEAD-UNRESOLVED"
BLOCKED_REVIEW_MERGE_BASE_UNRESOLVED: Final[str] = "BLOCKED-REVIEW-MERGE-BASE-UNRESOLVED"
...
BLOCKED_SERVER_DISCOVERY_NOT_FOUND: Final[str] = "BLOCKED-SERVER-DISCOVERY-NOT-FOUND"
BLOCKED_SERVER_DISCOVERY_AMBIGUOUS: Final[str] = "BLOCKED-SERVER-DISCOVERY-AMBIGUOUS"
BLOCKED_SERVER_AUTH_REQUIRED: Final[str] = "BLOCKED-SERVER-AUTH-REQUIRED"
BLOCKED_SERVER_DISCOVERY_UNSUPPORTED_PLATFORM: Final[str] = "BLOCKED-SERVER-DISCOVERY-UNSUPPORTED-PLATFORM"
BLOCKED_ENVIRONMENT_CONSTRAINT: Final[str] = "BLOCKED-ENVIRONMENT-CONSTRAINT"
...
CANONICAL_REASON_CODES: Final[tuple[str, ...]] = (
    ...
    BLOCKED_REVIEW_REMOTE_UNAVAILABLE,
    BLOCKED_REVIEW_FETCH_FAILED,
    BLOCKED_REVIEW_BASE_UNRESOLVED,
    ...
    BLOCKED_SERVER_DISCOVERY_NOT_FOUND,
    BLOCKED_SERVER_DISCOVERY_AMBIGUOUS,
    BLOCKED_SERVER_AUTH_REQUIRED,
    BLOCKED_SERVER_DISCOVERY_UNSUPPORTED_PLATFORM,
    BLOCKED_ENVIRONMENT_CONSTRAINT,
