...
Target Structure (defined in governance_runtime/contract.py via ALLOWED_PREFIXES):
...
- governance_runtime/         → GOVERNANCE_RUNTIME (legacy)
...
from governance_runtime.contract import ALLOWED_PREFIXES, get_allowed_prefixes_for_layer
