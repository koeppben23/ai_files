"""Canonical runtime repository root resolver (Git evidence only)."""
...
from governance_runtime.domain.reason_codes import BLOCKED_EXEC_DISALLOWED, BLOCKED_REPO_IDENTITY_RESOLUTION, REASON_CODE_NONE
from governance_runtime.infrastructure.path_contract import PathContractError, normalize_absolute_path
