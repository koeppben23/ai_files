...
from governance_runtime.engine.reason_codes import DEFAULT_UNMAPPED_AUDIT_REASON
...
def main() -> int:
    ...
    parser.add_argument(
        "--map",
        type=Path,
        default=SCRIPT_DIR.parent / "assets" / "catalogs" / "AUDIT_REASON_CANONICAL_MAP.json",
