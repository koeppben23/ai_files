...
from governance_runtime.entrypoints.write_policy import EFFECTIVE_MODE, is_write_allowed, write_policy_reasons, writes_allowed
...
from governance_runtime.infrastructure.logging.error_logs import safe_log_error
...
def main() -> int:
    ...
    commands_home = normalize_absolute_path(
        str(binding_paths.get("commandsHome", "")),
        purpose="paths.commandsHome",
    )
