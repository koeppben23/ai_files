...
def test_phase4_resolver_resolves_canonical_path():
    from governance_runtime.infrastructure.phase4_config_resolver import CanonicalRootConfigResolver
...
def test_phase5_resolver_resolves_canonical_path():
    from governance_runtime.infrastructure.phase5_config_resolver import CanonicalRootPhase5ConfigResolver
...
def test_runtime_wiring_configures_phase_resolvers():
    ...
    from governance_runtime.application.use_cases.phase4_self_review import get_config_path_resolver as get_phase4_resolver
    from governance_runtime.application.use_cases.phase5_review_config import get_config_path_resolver as get_phase5_resolver
