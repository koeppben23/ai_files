...
def _write_archive_run(workspace: Path, run_id: str, phase: str, next_token: str, gate: str) -> None:
    ...
    _write_json(
        run_root / "provenance-record.json",
        {
            ...
            "repo_fingerprint": "abc123def456abc123def456",
            "repo_slug": "abc123def456abc123def456",
            "run_id": run_id,
            "session_id": run_id,
    ...
    checksums = {
        ...
        "files": {
            ...
            "ticket-record.json": _sha256_file(run_root / "ticket-record.json"),
            "review-decision-record.json": _sha256_file(run_root / "review-decision-record.json"),
            "outcome-record.json": _sha256_file(run_root / "outcome-record.json"),
            "evidence-index.json": _sha256_file(run_root / "evidence-index.json"),
        },
    }
