...
def test_cleanup_decision_log_covers_required_candidates() -> None:
    ...
    required = [
        "historical/governance_content_docs/governance-layer-separation-decisions.md",
        "historical/governance_spec_migrations/R2_Migration_Units.md",
        "historical/governance_spec_migrations/R2_Import_Inventory.md",
        "historical/governance_spec_migrations/WAVE_22_MIGRATION_INVENTORY.md",
...
def test_cleanup_decision_log_matches_path_reality() -> None:
    must_exist = [
        REPO_ROOT / "historical" / "governance_content_docs" / "governance-layer-separation-decisions.md",
        REPO_ROOT / "historical" / "governance_spec_migrations" / "R2_Migration_Units.md",
        REPO_ROOT / "historical" / "governance_spec_migrations" / "R2_Import_Inventory.md",
        REPO_ROOT / "historical" / "governance_spec_migrations" / "WAVE_22_MIGRATION_INVENTORY.md",
    ]
    must_not_exist = [
