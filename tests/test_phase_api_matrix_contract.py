...
def test_all_defined_transitions_can_be_triggered_once(tmp_path: Path) -> None:
    ...
    cases = [
        ...
        ("6", {"active_gate": "Implementation Accepted"}, 1, "phase-6-implementation-accepted"),
        ("6", {"active_gate": "Implementation Blocked"}, 1, "phase-6-implementation-blocked"),
        (
            "6",
            {"active_gate": "Implementation Rework Clarification Gate", "implementation_rework_clarification_required": True},
            1,
            "phase-6-implementation-rework-clarification",
        ),
