...
def test_phase_router_blocks_phase2_without_workspace_ready():
    routed = route_phase(
        ...
        session_state_document={"SESSION_STATE": {"PersistenceCommitted": False, "workspace_ready_gate_committed": False, "WorkspaceArtifactsCommitted": False, "PointerVerified": False}},
...
def test_phase_router_routes_openapi_from_phase21_to_3a():
    routed = route_phase(
        ...
        session_state_document={"SESSION_STATE": {"PersistenceCommitted": True, "workspace_ready_gate_committed": True, "WorkspaceArtifactsCommitted": True, "PointerVerified": True, "repo_capabilities": ["openapi"], "Scope": {"BusinessRules": "not-applicable"}}},
...
def test_phase_router_prevents_backward_transition_from_persisted_phase():
    routed = route_phase(
        ...
        requested_active_gate="Discovery",
        requested_next_gate_condition="Proceed",
        session_state_document={"SESSION_STATE": {"phase": "3A-API-Inventory", "PersistenceCommitted": True, "workspace_ready_gate_committed": True, "WorkspaceArtifactsCommitted": True, "PointerVerified": True}},
        repo_is_git_root=True,
    )
    assert routed.phase == "3A-API-Inventory"
...
def test_phase_router_blocks_jump_without_transition_evidence():
    routed = route_phase(
        ...
        requested_next_gate_condition="Proceed",
        session_state_document={"SESSION_STATE": {"phase": "2-Discovery", "PersistenceCommitted": True, "workspace_ready_gate_committed": True, "WorkspaceArtifactsCommitted": True, "PointerVerified": True}},
        repo_is_git_root=True,
    )
...
def test_phase_router_strips_ticket_prompt_before_phase4():
    routed = route_phase(
        ...
        session_state_document={"SESSION_STATE": {"PersistenceCommitted": True, "workspace_ready_gate_committed": True, "WorkspaceArtifactsCommitted": True, "PointerVerified": True}},
        repo_is_git_root=True,
    )
