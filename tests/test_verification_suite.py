...
def test_phase_router_routes_openapi_from_phase21_to_3a():
    routed = route_phase(
        ...
        session_state_document={"SESSION_STATE": {"PersistenceCommitted": True, "workspace_ready_gate_committed": True, "WorkspaceArtifactsCommitted": True, "PointerVerified": True, **RULEBOOK_BASE, "RepoDiscovery": {"Completed": True, "RepoCacheFile": "cache", "RepoMapDigestFile": "digest"}, "repo_capabilities": ["openapi"], "Scope": {"BusinessRules": "gap-detected"}, "BusinessRules": {"Outcome": "gap-detected", "ExecutionEvidence": True}}},
