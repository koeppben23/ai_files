...
Pack files live under `governance/*_QUALITY_BENCHMARK_PACK.json`.
...
```bash
${PYTHON_COMMAND} scripts/run_quality_benchmark.py --pack governance/PYTHON_QUALITY_BENCHMARK_PACK.json
```
