                ...
                "CodebaseContext": {
                    ...
                    "properties": {
                        ...
                        "BusinessRuleCandidates": {
                            ...
                            "items": {
                                "type": "object",
                                "required": ["id", "candidate_rule_text", "source_path", "pattern_type", "confidence"],
                                "properties": {
                                    "id": {"type": "string", "pattern": "^BR-C\\d{3,}$"},
                                    "candidate_rule_text": {"type": "string"},
                                    ...
                                    "evidence_snippet": {"type": "string", "maxLength": 500},
                                },
                                "additionalProperties": False,
                            },
                        },
