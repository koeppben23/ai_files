...
from governance.engine import spec_classifier, content_classifier, command_surface
...
def validate_single_path(
    ...
    if check_layer:
        from governance.enforce import enforce_layers
    ...
    if check_state_location:
        from governance.enforce import check_state_file_location
    ...
    if check_packaging:
        from governance.enforce import check_packaging_rules
