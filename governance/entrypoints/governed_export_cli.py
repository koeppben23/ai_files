...
Usage:
    python -m governance.entrypoints.governed_export_cli \\
...
from governance.domain.regulated_mode import DEFAULT_CONFIG, RegulatedModeConfig, RegulatedModeState
from governance.infrastructure.governance_hooks import detect_regulated_mode
